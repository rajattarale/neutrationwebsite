...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Neutration - Free Yoga Website Template</title>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-12 col-md-6">
                        <div class="hero-text">
                            <h1>Nutrition Plans for Individuals</h1>
                            <p>
                                Get Guidance for Weight Loss / Weight Gain Diets, Sports & Workout Nutrition
                                    ​Diets for PCOD, Diabetes, Hypertension, Pre / Post Pregnancy & Kids
                            </p>
                            <div class="hero-btn">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-6">
                        <div class="about-img">
                            <img src="img/neutration1.jpg" alt="Image">
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6">
                        <div class="section-header text-left">
                            <p>Learn About Us</p>
                            <h2>Welcome to Nutrition</h2>
                        </div>
     ...
     <!--   <div class="price">
        ...
        <div class="testimonial wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="section-header text-center">
                    <p>Testimonial</p>
                    <h2>VIRTUAL CLASSROOM COURSES</h2>
                </div>
